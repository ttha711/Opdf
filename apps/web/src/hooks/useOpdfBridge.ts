...
function preprocessCanvasForOcr(canvas: HTMLCanvasElement) {
...
async function runBrowserOcrWithTextLayer(pdfBytes: Uint8Array, language: string, onProgress?: (value: number) => void): Promise<Uint8Array> {
